    ...
    with tab1:
        ...
        if st.button("공지 올리기"):
            if new_notice:
                ...
                save_table("notices", pd.DataFrame(st.session_state.notices), NOTICE_COLS)
                st.success("공지가 Supabase에 저장되었습니다.")
                st.rerun()
